...
LOG_FILE="$WORKSPACE_ROOT/logs/weekly-pipeline.log"
...
WEEK_FILES=$(find "$MARKETING_DIR" -name "*.md" -newer "$WORKSPACE_ROOT/reports/weekly/" -mtime -7 2>/dev/null | head -20 | while read f; do basename "$f"; done | tr '\n' ', ')
...
echo "    - Weekly report"
echo ""
echo "  Review queue: $(find "$WORKSPACE_ROOT/approvals/review" -type f -name "*.md" 2>/dev/null | wc -l | tr -d ' ') items"
echo "  Log: $LOG_FILE"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
