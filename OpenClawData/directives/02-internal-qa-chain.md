...
- Ensure product mentions are contextually useful

## Role 5: Accuracy Reviewer
- Reject hallucinated facts
- Reject inflated claims
- Reject ambiguous or risky wording

## Role 6: Publisher
- Decide: publish now, schedule, convert, or skip
- Only publish if quality clears the threshold

## Role 7: Performance Analyst
