...
# Reads: data source folders + .meta.json classification files
# Writes: Content drafts to data output folders + queues/*/pending/
# Logs: logs/content-agent.log
...
LOG_FILE="$WORKSPACE_ROOT/logs/content-agent.log"
...
PROCESSED_LOG="$WORKSPACE_ROOT/logs/content-produced-files.log"
touch "$PROCESSED_LOG"
